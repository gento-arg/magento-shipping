...
use Gento\Shipping\Controller\Adminhtml\Location\Edit;
use Magento\Framework\View\Page\Config;

class EditTest extends TestCase
{
    /**
     * @covers \Gento\Shipping\Controller\Adminhtml\Location\Edit::execute()
     */
    public function testExecute()
    {
        ...
        $controller = new Edit($context, $locationRepository, $registry);
